  ...
  return (
    <article className="post" id="resume">
      ...
      <section
        ...
        style={{
          padding: '20px 0',
          borderLeft: activeSection === 'education' ? '4px solid #000000' : '4px solid transparent',
          paddingLeft: '20px',
          transition: 'all 0.3s ease',
          borderRadius: '8px',
          marginBottom: '20px',
      ...
      <section
        ...
        style={{
          padding: '20px 0',
          borderLeft:
            activeSection === 'experience' ? '4px solid #000000' : '4px solid transparent',
          paddingLeft: '20px',
          transition: 'all 0.3s ease',
          borderRadius: '8px',
          marginBottom: '20px',
      ...
      <section
        ...
        style={{
          padding: '20px 0',
          borderLeft: activeSection === 'skills' ? '4px solid #000000' : '4px solid transparent',
          paddingLeft: '20px',
          transition: 'all 0.3s ease',
          borderRadius: '8px',
          marginBottom: '20px',
